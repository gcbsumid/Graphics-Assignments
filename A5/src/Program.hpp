...
\
    ...
    _PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLfloat)
    _PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLdouble)
    _PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLint)
    _PROGRAM_ATTRIB_N_UNIFORM_SETTERS(GLuint)
