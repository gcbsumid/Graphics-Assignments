...
static GLenum TextureFormatForBitmapFormat(Bitmap::E_FORMAT format, bool srgb) {
    switch (format) {
        case Bitmap::E_FORMAT_GREYSCALE: return GL_LUMINANCE;
        case Bitmap::E_FORMAT_GREYSCALEALPHA: return GL_LUMINANCE_ALPHA;
        case Bitmap::E_FORMAT_RGB: return (srgb ? GL_SRGB : GL_RGB);
        case Bitmap::E_FORMAT_RGBA: return (srgb ? GL_SRGB_ALPHA : GL_RGBA);
