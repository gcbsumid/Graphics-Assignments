...
inline Point4D operator +(const Point4D& a, const Vector3D& b)
{
  return Point4D(a[0]+b[0], a[1]+b[1], a[2]+b[2], a[3]);
}
...
inline Vector3D operator -(const Point4D& a, const Point4D& b)
{
  return Vector3D(a[0]-b[0], a[1]-b[1], a[2]-b[2]);
}
